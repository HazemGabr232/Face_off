...
flag = [0, 0, 0]
cloud = ['0', '5643f1c8a5133f5d65c4731773fc91a9', 'a8cd83d68c84b834f4fbf42e0d20ef02']
subjects = ["", "Adel", "Hazem"]
...
def detect_face(img):
    ...
    face_cascade = cv2.CascadeClassifier(r"C:\Users\Aliaa Ezz\Downloads\opencv\sources\data\lbpcascades\lbpcascade_frontalface.xml")
...
def prepare_training_data(data_folder_path):
    ...
    for dir_name in dirs:
        ...
        subject_dir_path = "E:/FaceOffPhotos" +"/" + dir_name
        ...
        for image_name in subject_images_names:
            ...
            image_path = subject_dir_path + "/" + "malan.jpg"
...
faces, labels = prepare_training_data("E:\FaceOffPhotos")
print("Data prepared")
...
while True:
    ...
    gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
    face_cascade = cv2.CascadeClassifier('C:/Users/Aliaa Ezz/Downloads/opencv/sources/data/lbpcascades/lbpcascade_frontalface.xml')
